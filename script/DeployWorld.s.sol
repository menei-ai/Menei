...
/// The world edition on the full venue: USDG plus the same twenty six
/// assets, frozen at deploy forever. Everything the pension edition does,
/// plus published policies, followers and royalties.
contract DeployWorld is Script {
    ...
    function run() external {
        ...
        vm.stopBroadcast();
        console2.log("AUM0 world edition deployed at:", address(aum));
    }
